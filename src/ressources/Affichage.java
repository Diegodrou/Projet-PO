...
public class Affichage {
    ...
    /**
     * Affiche un texte aligné à gauche avec la police et la couleur rouge.
     * 
     * @param x     Abscisse du bord gauche du texte
     * @param y     Ordonnée du centre du texte
     * @param texte Texte à afficher
     */
    public static void texteGaucheR(double x, double y, String texte) {
        texteGauche(x, y, texte, Config.POLICE_PAR_DEFAUT, new Color(255, 0, 0));
    }

    /**
     * Affiche un texte aligné à gauche avec la police et la couleur vert.
     * 
     * @param x     Abscisse du bord gauche du texte
     * @param y     Ordonnée du centre du texte
     * @param texte Texte à afficher
     */
    public static void texteGaucheV(double x, double y, String texte) {
        texteGauche(x, y, texte, Config.POLICE_PAR_DEFAUT, new Color(0, 255, 0));
    }
